    ...
    return Consumer<CartProvider>(
      builder: (context, cart_provider, __) {
        return Scaffold(
                        ...
                        (cart_provider.cartList.isEmpty)
                            ...
                            : ListView.builder(
                                ...
                                itemBuilder: (context, index) {
                                  return CartItemCard(
                                      itemName: cart_provider
                                          .cartList[index].menuItemName!,
                                      imageUrl: cart_provider
                                          .cartList[index].menuItemImage!,
                                      price: cart_provider
                                          .cartList[index].menuItemPrice!,
                                      quantity: cart_provider
                                          .cartList[index].quantity
                                          .toString(),
                                      addQuantitycallback: () {
                                        cart_provider
                                            .incrementItemQuantityUpdate(
                                                cart_provider.cartList[index]);
                                        var data = {
                                          "menu_item": cart_provider
                                              .cartList[index].menuItem,
                                          "quantity": cart_provider
                                              .cartList[index].quantity
                                        };
                                        cart_provider.updateItemQuantity(
                                            data,
                                            cart_provider.cartList[index].id!,
                                            context);
                                      },
          ...
          bottomNavigationBar: cart_provider.cartList.isEmpty
              ...
              : Hero(
                  ...
                  child: Padding(
                    ...
                    child: SizedBox(
                      ...
                      child: CustomButton(
                          onPressed: () async {
                            List.generate(cart_provider.cartList.length,
                                (index) {
                              cartItemList.add({
                            ...
                            var data = {
                              ...
                              "order_instructions":
                                  order_provider.instructionController.text
                            };
