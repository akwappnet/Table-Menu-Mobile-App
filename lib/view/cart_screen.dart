                                            ...
                                            children: [
                                              ...
                                              PlusMinusButtons(
                                                addQuantity: () {
                                                  ...
                                                  var data = {
                                                    "menu_item": cart_items[index]
                                                        .menuItem,
                                                    "quantity": cart_provider
                                                        .quantity
                                                  };
                                                  cart_provider.updateCart(
                                                      context, data,
                                                      cart_items[index].id!);
                                                },
                                                deleteQuantity: () {
                                                ...
                                                text: cart_items[index].quantity
                                                    .toString(),
                                              ),
                                              IconButton(
                                                  onPressed: () {
                            ...
                            child: CustomButton(
                              onPressed: () {
                                List.generate(cart_items.length, (index) {
                                  cartItemList.add(
                                      {
                                        "item_price": double.parse(cart_items[index].totalPrice!),
                                        "quantity": cart_items[index].quantity,
                                        "item_name": cart_items[index].menuItemName
                                      }
                                  );
                                });
                                userId = cart_items[0].user ?? 0;
                                var data = {
                                  "user": userId,
