                                            ...
                                            child: Container(
                                              ...
                                              child: Card(
                                                child: Container(
                                                  padding: const EdgeInsets.all(8.0),
                                                  child: ListTile(
                                                    leading: Image.network(ApiEndPoint.baseImageUrl + menu_items[index].image.toString()),
                                                    title: Column(
                                                      children: [
                                                        Row(
                                                          children: [
                                                            if (menu_items[index].isVeg == true)
                                                              Image.asset(
                                                            ...
                                                            const Spacer(),
                                                            if (menu_items[index].isNew == true)
                                                              Container(
                                                                decoration: BoxDecoration(
                                                        ...
                                                        Row(
                                                          children: [
                                                            Text(
                                                              menu_items[index].name.toString(),
                                                        ...
                                                        Row(
                                                          children: [
                                                            Text(
                                                              menu_items[index].ingredients.toString(),
                                                        ...
                                                        Row(
                                                          children: [
                                                            Text(
                                                              ...
                                                              style: textMediumStyle.copyWith(fontWeight: FontWeight.bold),
                                                            ),
                                                            const Spacer(),
                                                            if (menu_items[index].isSpicy == true)
                                                              Text(
                                                                "Spicy, ",
                                                                style: smallRegularStyle,
                                                              ),
                                                            if (menu_items[index].isSweet == true)
                                                              Text(
                                                                "Sweet, ",
                                                                style: smallRegularStyle,
                                                              ),
                                                            if (menu_items[index].isSpecial == true)
                                                              Text(
                                                                "Special, ",
                                                                style: smallRegularStyle,
                                                              ),
                                                            if (menu_items[index].isPopular == true)
                                                              Text(
                                                                "Popular ",
                                                                style: smallRegularStyle,
                                                              ),
