    ...
    return Consumer<MenuProvider>(
      builder: (_, menu_provider,__){
        return Scaffold(
          ...
          body: SafeArea(
            child: menu_provider.menuitems.isNotEmpty || menu_provider.categories.isNotEmpty ?
                  (qr_provider.isVisible)
                    ...
                    child: Column(
                      children: [
                        ...
                        Flexible(
                            flex: 2,
                            child: (menu_provider.categories.isNotEmpty)
                                ? ListView(
                              ...
                              children: <Widget>[
                                ...
                                ListView.builder(
                                    ...
                                    scrollDirection: Axis.horizontal,
                                    itemCount: menu_provider.categories.length,
                                      ...
                                      return GestureDetector(
                                        onTap: () {
                                          ...
                                          menu_provider.setCategoryName(
                                              menu_provider.categories[index]
                        ...
                        Expanded(
                                flex: 5,
                                child: (menu_provider.menuitems.isEmpty)
                                    ? const PlaceholderWidget(title: 'No Menu Items',)
                                    : Consumer<CartProvider>(
                                  builder: (context, cart_provider, __) {
                                    return GridView.builder(
                                      gridDelegate: const SliverGridDelegateWithFixedCrossAxisCount(
                                        crossAxisCount: 2, // Number of columns in the grid
                                        childAspectRatio: 0.82, // Width to height ratio of each item
                                      ),
                                      itemCount: menu_provider.menuitems.length,
                                      shrinkWrap: true,
                                      itemBuilder: (context, index) {
                                        return GestureDetector(
                                          onTap: () {
                                            Navigator.pushNamed(context, RoutesName.MENU_ITEM_DETAILS_SCREEN_ROUTE,arguments: menu_provider.menuitems[index]);
